...
Select round(sum(total)) as sum_of_invoice, billing_city 
from invoice 
...
(
Select ar.artist_id, ar.name, round(Sum(il.unit_price*il.quantity)) as total_sales
...
round(Sum(il.unit_price*il.quantity)) as amount_spent
from invoice i
